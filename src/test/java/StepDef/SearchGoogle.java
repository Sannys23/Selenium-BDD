...
public class SearchGoogle {
    ...
    public void showingResultRelatedWith(String result) {
        driver.findElement(By.xpath("//a[@href='https://www.linkedin.com/in/sanny-era-eliza-siallagan/']")).isDisplayed();
        String urlLinkedinSanny = driver.findElement(By.xpath("//a[@href='https://www.linkedin.com/in/sanny-era-eliza-siallagan/']")).getText();
        System.out.println(urlLinkedinSanny);
        driver.close();
        driver.quit();
    }
}
